...
namespace NewRestApi.Controllers
{
    ...
    {
        private readonly NewRestApiContext _context;

        public StudentsController(NewRestApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Students>> PostStudents(Students students)
        {
          if (_context.Students == null)
          {
              return Problem("Entity set 'NewRestApiContext.Students'  is null.");
          }
